...
The length--scale of the potential is given by $\sigma_{ij}$ (chosen to be equal for all pairs of $i$ and $j$) while the parameter $\epsilon_{ij}$ determines the strength of the interaction. 
...
Instead this was calculated by saving the particle positions on a given timestep to a file and post--processing.
