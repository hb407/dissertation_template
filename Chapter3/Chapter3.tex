...
The pressure in the mixture periodic in all dimensions is regulated using a Nos\'{e}--Hoover barostat whilst for the confined fluid, the walls are used to create a piston.	
}
	\label{SetUp}
\end{figure}
