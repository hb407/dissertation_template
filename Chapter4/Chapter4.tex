...
\caption{The fluid velocity generated from a non--equilibrium simulation with an applied artifical Marangoni force shows a peak at the interface with a flow direction from warm regions to cold.
...
The maximum values are similari, suggesting that fixing the total force to zero correctly adjusts the data to give a physically meaningful Marangoni force.
